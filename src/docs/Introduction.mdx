...
Also, there are structures of types in [Type](/docs/type-palettetype--docs) categories.
<br />

## Troubleshooting

Refer to the [Troubleshooting](/docs/introduction-troubleshooting--docs) page for solutioins of frequently occurring issues.